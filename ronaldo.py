...
class ronaldo_page_scraper(scrapy.Spider):
    name = 'ronaldo'

    start_urls = ['https://fbref.com/en/players/dea698d9/all_comps/Cristiano-Ronaldo-Stats---All-Competitions']

    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'ronaldo.csv',
        'FEED_EXPORT_ENCODING': 'utf-8'
    }

    def parse(self, response):
        base_url = "https://fbref.com"
        seasons  = response.css("a[href*= '/summary/Cristiano-Ronaldo-Match-Logs']")
        links = seasons.css("a::attr(href)").extract()[0:19]
